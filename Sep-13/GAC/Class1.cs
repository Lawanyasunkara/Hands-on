...
namespace GAC
{
    ...
    public class User : Movie
    {
        ...
        {
            Movie m = new Movie("VakeelSab", "Telugu", "Action", 20);
            dbmovies.Add(m);
            Movie k = new Movie("Jalsa", "Telugu", "Drama", 30);
            dbmovies.Add(k);
            Movie t = new Movie("RRR", "Telugu", "Action", 30);
            dbmovies.Add(t);
            Movie n = new Movie("Nayak", "Telugu", "Action", 30);
            dbmovies.Add(n);
