...
namespace Sep14
{
    internal class Program
    {
        ...
        mer:
            ...
            Console.WriteLine("Already watched movie");
            f1.releaselist();
            List<Movie> dgg = new List<Movie>();
            foreach (var item in f1.release)
            {
                dgg.Add(item.Item1);
            }
            s1.alreadyseen = dgg;
            ...
            Console.WriteLine("Already watched movies");
